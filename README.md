...
Abre la carpeta del proyecto y ejecuta index.html (o proyecto.html) directamente en tu navegador, o usa una extensión como Live Server en VS Code para evitar problemas de rutas.
